...
CREATE TABLE user_ledger (
    ...
    auth_secret_hash VARCHAR(256) NULL COMMENT 'Hashed agent secret for API authentication',
    auth_secret_salt VARCHAR(64) NULL COMMENT 'Salt used for hashing agent secrets',
    session_token_version INT UNSIGNED NOT NULL DEFAULT 1 COMMENT 'Bumps to invalidate issued session tokens',
